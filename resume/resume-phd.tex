...
Vision models that hold up outside the benchmark: in the clinic, in the lab, and behind APIs nobody gets to retrain. I care about interpretability as something a domain expert can act on rather than a figure in an appendix, about how learned representations transfer to scientific imaging where the data and labels look nothing like natural photographs, and about how much of a generative model's behavior can be steered when its weights are out of reach. Building ML for a regulated clinical platform alongside the research keeps those questions tied to decisions with real consequences.
